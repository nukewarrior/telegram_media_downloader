...
export type Settings = { apiId: string | null; apiHashConfigured: boolean; archiveTimezone: string | null; accountConnected: boolean; accountName: string | null; accountPhone: string | null; connectionStatus: ConnectionStatus; downloadRoot: string; trustedLanWarning: string; download: DownloadRuntime; sourceCache: { maxBytes: number } }
