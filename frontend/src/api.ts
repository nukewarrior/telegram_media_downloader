...
export type TaskMedia = { id: number; task_id: number; message_id: number; filename: string; media_type: string; mime_type: string | null; size_bytes: number; message_date: string; status: string; error_message: string | null; downloaded_bytes: number; speed_bytes_per_second: number; updated_at: string; revision: number; percent: number; attempt_count: number; next_retry_at: string | null; failure_category: string | null; thumbnail_url: string | null }
