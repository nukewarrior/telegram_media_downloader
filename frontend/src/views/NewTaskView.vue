...
import { api, type Chat, type ChatListSnapshot } from '../api'
...
onMounted(async () => { const cached = readChatCache(); if (cached) applyChatSnapshot(cached); await loadChats() })
</script>
